"""
Main Slack bot application - Functional approach with async support
"""
import logging
import asyncio
import signal
...
from rag_module.rag_client import search as search_rag
from rag_module.rag_client import health_check as rag_health_check
