...
# Configuration
REGISTRY ?= 543148812499.dkr.ecr.us-east-2.amazonaws.com/supbot
TAG ?= latest
...
deploy-app: ## Deploy Slack app
	...
	sed -i.bak 's|543148812499.dkr.ecr.us-east-2.amazonaws.com/supbot/slack-app:latest|$(SLACK_APP_IMAGE)|g' kubernetes/slack-app/deployment.yaml
...
deploy-sync: ## Deploy sync job
	@echo "Updating image references..."
	sed -i.bak 's|543148812499.dkr.ecr.us-east-2.amazonaws.com/supbot/sync-job:latest|$(SYNC_JOB_IMAGE)|g' kubernetes/sync-job/cronjob.yaml
